...
public class BookService {
  // fields
    ...
    // create purchaseRepository to deal with return book from purchase
  ...
  // methods
    ...
    public ReturnBookResponseDTO returnBook(ReturnBookRequestDTO dto) throws NotFoundException, DatabaseException{
        ...
        Purchase purchase = purchaseRepository
                .findById(purchaseId)
                .orElseThrow(() -> new NotFoundException("ReturnBook--purchase not found with id: " + purchaseId));

        // find book based on book id in purchase
        Long bookId = purchase.getBook().getId();
        Book book = bookRepository
                .findById(bookId)
                .orElseThrow(() -> new NotFoundException("ReturnBook--book not found for with id: " + bookId));
